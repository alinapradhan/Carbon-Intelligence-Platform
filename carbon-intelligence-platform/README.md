...
A Siemens-inspired, local-only carbon emissions analytics and sustainability intelligence platform for industrial facilities, manufacturing campuses, and power-grid-connected operations. The repository is designed as a portfolio-quality implementation that demonstrates clean architecture, carbon accounting, ESG analytics, AI forecasting, anomaly detection, and modern industrial dashboard engineering.
